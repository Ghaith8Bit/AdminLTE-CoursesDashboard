                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item"
                                                href="{{ route('dashboard.courses.show', $course) }}">Show</a>
                                            @if (auth()->user()->isAdmin())
                                                ...
                                                <form action="{{ route('dashboard.courses.destroy', $course) }}"
                                                    ...
                                                    @method('DELETE')
                                                    <a class="dropdown-item"
                                                        href="{{ route('dashboard.courses.destroy', $course) }}"
                        ...
                        <form id="coursesFilterForm">
                            <div class="form-row mb-3">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" class="form-control mt-2" id="priceFilterValue" name="price_value"
                                        placeholder="Enter price">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="startDateFilter">Start Date</label>
                                    <select class="form-control" id="startDateFilterOperator" name="start_date_operator">
                                        <option value="eq">Equal to</option>
                                        <option value="neq">Not equal to</option>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" id="endDateFilterOperator" name="end_date_operator">
                                        <option value="eq">Equal to</option>
                                        <option value="neq">Not equal to</option>
                                        <option value="gt">After</option>
                                        <option value="gte">On or after</option>
        ...
        @foreach ($courses as $course)
            <div class="modal fade" id="editModal{{ $course->id }}" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action="{{ route('dashboard.courses.update', $course) }}" method="POST"> @csrf
                            ...
                            <div class="modal-body">
                                <div class="form-group"> <label for="name">Name</label> <input type="text"
                                        class="form-control" id="name" name="name" value="{{ $course->name }}">
                                </div>
                                <div class="form-group"> <label for="description">Description</label>
                                    <textarea class="form-control" id="description" name="description">{{ $course->description }}</textarea>
                                </div>
                                <div class="form-group"> <label for="price">Price</label> <input type="number"
